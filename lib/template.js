class word_card extends HTMLElement {
    constructor() {
        ...
        this.querySelector("#n").value = value[0];
        this.querySelector("#n").style.background = rgb("k", value[0]);
        this.querySelector("#n").oninput = () => {
            this.setAttribute("value", this.querySelector("#n").value);
            this.querySelector("#n").style.background = rgb("k", this.querySelector("#n").value);
            word_value_write(this.getAttribute("word"), "k", Number(this.querySelector("#n").value));
            setTimeout(() => {
                this.focus();
            }, 100);
        };
        this.querySelector("#s").value = value[1];
        this.querySelector("#s").style.background = rgb("s", value[1]);
        this.querySelector("#s").oninput = () => {
            this.setAttribute("value", this.querySelector("#s").value);
            this.querySelector("#s").style.background = rgb("s", this.querySelector("#s").value);
